...
urlpatterns = [
    ...
    path('trades/<int:pk>/export-pdf/', views.ExportTradePDFView.as_view(), name='export_trade_pdf'),
    path('trades/<int:pk>/export-excel/', views.ExportTradeExcelView.as_view(), name='export_trade_excel'),
