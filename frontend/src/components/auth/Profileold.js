...
const Profile = () => {
      ...
      try {
        ...
        if (response.data) {
          ...
          setSubscription(prev => ({
            ...
            remainingTrades: subData.trades_limit - subData.trades_used,
        ...
        // اگر اشتراک در بک‌اند نبود، از localStorage استفاده کن
  ...
  // تابع بررسی انقضای اشتراک (برای حالت localStorage)
  ...
  // ============================================
  // ✅ تابع تمدید اشتراک - هدایت به صفحه تمدید
  // ============================================
const handleRenewSubscription = () => {
  console.log('🔄 Clicked renew subscription button - navigating to /subscription/renew');
    ...
    <div className={`profile-container ${isDark ? 'dark' : 'light'}`}>
      ...
      <div className="profile-content">
        ...
        <div className="profile-card">
          ...
          {/* ✅ دکمه تمدید اشتراک - هدایت به صفحه تمدید */}
          <button
            className="btn-renew"
