...
// ============================================
// ✅ کامپوننت راهنمای قوانین معاملاتی (تکمیل‌شده)
// ============================================
  const RulesGuide = () => {
        ...
        {isOpen && (
          <div className="rules-guide-content">
            ...
            <div className="guide-extra-info">
              <div className="guide-section">
                <h4>📊 تأثیر قوانین بر عملکرد معاملاتی</h4>
                <p>
                  تحقیقات نشان می‌دهد که معامله‌گرانی که به قوانین خود پایبند هستند،
                  به طور میانگین <strong>۲.۵ برابر</strong> سودآورتر از معامله‌گرانی هستند که قوانین مشخصی ندارند.
                  پایبندی به قوانین باعث <strong>کاهش استرس</strong>، افزایش <strong>اعتمادبه‌نفس</strong> و
                  بهبود <strong>تصمیم‌گیری</strong> در شرایط بازار می‌شود.
                </p>
              </div>

              <div className="guide-section">
                <h4>📈 چگونه قوانین مؤثر طراحی کنیم؟</h4>
                <ul>
                  <li>
                    <strong>ساده و مشخص:</strong> قوانین باید <strong>قابل اندازه‌گیری</strong> و
                    <strong>بدون ابهام</strong> باشند. مثلاً "حد ضرر را حداکثر ۱٪ از سرمایه قرار می‌دهم."
                  </li>
                  <li>
                    <strong>مبتنی بر داده:</strong> قوانین را بر اساس <strong>تحلیل تریدهای گذشته</strong> خود
                    طراحی کنید. ببینید چه عواملی باعث موفقیت یا شکست شما شده‌اند.
                  </li>
                  <li>
                    <strong>قابل اجرا:</strong> قوانین باید متناسب با <strong>سبک معاملاتی</strong> و
                    <strong>تحمل ریسک</strong> شما باشند. قوانین غیرواقعی فقط باعث سرخوردگی می‌شوند.
                  </li>
                  <li>
                    <strong>قابل بازنگری:</strong> قوانین خود را به‌صورت <strong>دوره‌ای</strong> (مثلاً هر ماه)
                    مرور کنید و بر اساس عملکرد خود بهبود دهید.
                  </li>
                </ul>
              </div>

              <div className="guide-section">
                <h4>🔍 تحلیل پایبندی به قوانین</h4>
                <p>
                  در بخش <strong>گزارشات پیشرفته</strong> و <strong>تحلیل عملکرد</strong>،
                  می‌توانید میزان پایبندی خود به هر قانون را مشاهده کنید:
                </p>
                <ul>
                  <li>
                    <strong>درصد پایبندی:</strong> چند درصد از مواقع قانون رعایت شده است.
                  </li>
                  <li>
                    <strong>تأثیر بر عملکرد:</strong> آیا رعایت قانون با <strong>سود</strong> همراه بوده است؟
                  </li>
                  <li>
                    <strong>روند پایبندی:</strong> آیا پایبندی شما به قوانین در حال <strong>بهبود</strong> است؟
                  </li>
                </ul>
                <p className="guide-tip">
                  💡 اگر متوجه شدید که یک قانون خاص را <strong>مرتباً نقض</strong> می‌کنید،
                  دو راه حل دارید: <strong>۱- آن قانون را اصلاح کنید</strong> تا قابل‌اجرا شود،
                  یا <strong>۲- آن را حذف کنید</strong> و روی قوانین دیگری تمرکز کنید.
                </p>
              </div>

              <div className="guide-section">
                <h4>🚀 استراتژی‌های بهبود پایبندی به قوانین</h4>
                <ul>
                  <li>
                    <strong>🏷️ برچسب‌گذاری:</strong> قوانین خود را در معرض دید قرار دهید.
                    آنها را روی دیوار یا دسکتاپ خود بنویسید.
                  </li>
                  <li>
                    <strong>📊 پیگیری روزانه:</strong> هر روز <strong>۵ دقیقه</strong> به مرور قوانین
                    و ارزیابی پایبندی خود اختصاص دهید.
                  </li>
                  <li>
                    <strong>🎯 هدف‌گذاری:</strong> برای هر هفته یک هدف پایبندی مشخص کنید.
                    مثلاً "این هفته ۹۰٪ به قوانین خود پایبند خواهم بود."
                  </li>
                  <li>
                    <strong>📝 ثبت نقض‌ها:</strong> هر بار که قانونی را نقض می‌کنید،
                    دلیل آن را یادداشت کنید. این کار به شما کمک می‌کند تا <strong>الگوهای نقض</strong> خود را شناسایی کنید.
                  </li>
                  <li>
                    <strong>🎉 پاداش:</strong> برای روزهایی که پایبندی عالی دارید،
              ...
              <div className="guide-section">
                <h4>⚠️ اشتباهات رایج در طراحی قوانین</h4>
                <ul>
                  <li>
                    <strong>❌ قوانین بسیار زیاد:</strong> بیش از <strong>۱۰ قانون</strong> معمولاً
                    قابل مدیریت نیستند. کمتر اما مؤثرتر باشید.
                  </li>
                  <li>
                    <strong>❌ قوانین مبهم:</strong> قوانینی که قابل اندازه‌گیری نیستند،
                    مانند "صبور باشم" یا "احساساتی نباشم".
                  </li>
                  <li>
                    <strong>❌ قوانین غیرواقعی:</strong> قوانینی که با شخصیت یا سبک معاملاتی شما
                    همخوانی ندارند.
                  </li>
                  <li>
                    <strong>❌ عدم بازنگری:</strong> قوانینی که به‌روز نمی‌شوند و با تغییر شرایط بازار
              ...
              <div className="guide-tip guide-tip-success">
                ...
                <div>
                  ...
                  <ul>
                    <li>
                      <strong>معامله‌گران با پایبندی بالا</strong> (بالای ۸۰٪) به طور میانگین
                      <strong> ۲.۵ برابر</strong> سودآورتر هستند.
                    </li>
                    <li>
                      <strong>هر ۱۰٪ افزایش در پایبندی</strong> به قوانین، سودآوری را
                      <strong> ۱۵٪</strong> افزایش می‌دهد.
                    </li>
                    <li>
                      <strong>نقض قوانین</strong> در بیش از <strong>۷۰٪</strong> موارد
                      با <strong>ضرر</strong> همراه است.
                    </li>
                    <li>
                      <strong>انضباط معاملاتی</strong> مهم‌ترین عامل <strong>موفقیت بلندمدت</strong>
